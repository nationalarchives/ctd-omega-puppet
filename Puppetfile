...
mod 'nvm',
    :git    => 'https://github.com/adamretter/puppet-nvm',
    :branch => 'hotfix/removed-validate-functions'
# mod 'swap_file',
#     :git    => 'https://github.com/Phil-Friderici/petems-swap_file',
#     :branch => 'pdk'
mod 'swap_file',
    :git    => 'https://github.com/traylenator/petems-swap_file',
    :branch => 'ralign'
mod 'vcsrepo',
